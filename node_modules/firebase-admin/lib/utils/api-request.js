...
import credential_internal_1 from "../app/credential-internal";
import index_1 from "../utils/index";
...
class AsyncRequestCall {
    ...
    handleMultipartResponse(response, respStream, boundary) {
        import busboy from "@fastify/busboy"; // eslint-disable-line @typescript-eslint/no-var-requires
...
class AsyncHttpCall extends AsyncRequestCall {
    ...
    uncompressResponse(res) {
        ...
        if (res.headers['content-encoding'] && encodings.indexOf(res.headers['content-encoding']) !== -1) {
            ...
            import zlib from "zlib"; // eslint-disable-line @typescript-eslint/no-var-requires
