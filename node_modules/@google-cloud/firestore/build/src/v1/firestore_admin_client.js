...
import jsonProtos from "../../protos/admin_v1.json";
/**
 * Client JSON configuration object, loaded from
 * `src/v1/firestore_admin_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import gapicConfig from "./firestore_admin_client_config.json";
...
class FirestoreAdminClient {
     ...
     *     ```
     *     import gax from "google-gax/build/src/fallback"; // avoids loading google-gax with gRPC
